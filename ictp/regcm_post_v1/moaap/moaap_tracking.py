...
data_vars = xr.open_dataset('/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/ERA5/EURR-3/EURR-3_ERA5_reanalysis_1hr_20000101.nc')
lon2d, lat2d = np.meshgrid(data_vars.longitude.values, data_vars.latitude.values)
