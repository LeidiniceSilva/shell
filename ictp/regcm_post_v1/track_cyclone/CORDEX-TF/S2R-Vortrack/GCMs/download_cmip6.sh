...
if [ ${mdl} == "GFDL-ESM4" ]; then
        ...
        freq="6hrPlevPt"
        version="v20200720"
        declare -a YEARS=("199901010600-200001010000" "200001010600-200101010000" "200101010600-200201010000" "200201010600-200301010000" "200301010600-200401010000" "200401010600-200501010000" "200501010600-200601010000" "200601010600-200701010000" "200701010600-200801010000" "200801010600-200901010000" "200901010600-201001010000")
else # UKESM1-0-LL
        mdl_family="MOHC"
        exp="historical"
        member="r1i1p1f2"
