...
for VAR in ${VAR_LIST[@]}; do
    #for YEAR in `seq -w 2018 2021`; do
        #for MON in `seq -w 01 12`; do
    	    #if [ ${VAR} == "sfcWindmax" ]
    	    #then
	    #CDO selname,${VAR} ${DIR_IN}/SAM-12_STS.${YEAR}${MON}0100.nc ${VAR}_${MODEL}_day_${YEAR}${MON}0100.nc
	    #else
	    #CDO selname,${VAR} ${DIR_IN}/SAM-12_SRF.${YEAR}${MON}0100.nc ${VAR}_${MODEL}_1hr_${YEAR}${MON}0100.nc
	    #fi	    	    
        #done
    #done
    ...
    if [ ${VAR} == "pr" ]
    then
    CDO mergetime ${VAR}_${MODEL}_1hr_*0100.nc ${VAR}_${MODEL}_1hr_2018-2021.nc
    ...
    then
    CDO mergetime ${VAR}_${MODEL}_day_*0100.nc ${VAR}_${EXP}_${MODEL}_day_2018-2021.nc
    ${BIN}/./regrid ${VAR}_${EXP}_${MODEL}_day_${DT}.nc -35.70235,-11.25009,0.03 -78.66277,-35.48362,0.03 bil
    else
    CDO mergetime ${VAR}_${MODEL}_1hr_*0100.nc ${VAR}_${EXP}_${MODEL}_1hr_2018-2021.nc
    CDO selhour,00,06,12,18 ${VAR}_${EXP}_${MODEL}_1hr_${DT}.nc ${VAR}_${EXP}_${MODEL}_6hr_${DT}.nc
    ${BIN}/./regrid ${VAR}_${EXP}_${MODEL}_1hr_${DT}.nc -35.70235,-11.25009,0.03 -78.66277,-35.48362,0.03 bil
    ${BIN}/./regrid ${VAR}_${EXP}_${MODEL}_6hr_${DT}.nc -35.70235,-11.25009,0.03 -78.66277,-35.48362,0.03 bil
    fi
