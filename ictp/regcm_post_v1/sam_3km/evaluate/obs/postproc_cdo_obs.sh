...
then
VAR_LIST="fg10"
#VAR_LIST="tp t2m tcc lcc mcc hcc msnlwrf pev cape cin swvl1 fg10 i10fg u u10max v v10max q r"
...
for VAR in ${VAR_LIST[@]}; do
    ...
    elif [ ${VAR} == 'fg10' ] || [ ${VAR} == 'i10fg' ] || [ ${VAR} == 'u10max' ] || [ ${VAR} == 'v10max' ]
    then
    CDO selyear,${IYR}/${FYR} ${DIR_IN}/${DATASET}/${VAR}_${DATASET}_day_2018-2021.nc ${VAR}_${EXP}_${DATASET}_day_${YR}.nc
    else
