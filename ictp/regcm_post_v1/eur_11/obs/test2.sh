...
for MON in `seq -w 01 01`; do
	...
	echo
	echo "2. Calculate mon mean"
	CDO mulc,1000 ${VAR}_${DATASET}_1hr_${IYR}${MON}01.nc ${VAR}_${EXP}_${DATASET}_1hr_${IYR}${MON}01.nc
	cdo daymean ${VAR}_${EXP}_${DATASET}_1hr_${IYR}${MON}01.nc ${VAR}_${EXP}_${DATASET}_${IYR}${MON}01.nc
