...
CDO mulc,1000 ${VAR}_${DATASET}_hr_${YR}.nc ${VAR}_${EXP}_${DATASET}_hr_${YR}.nc

echo
echo "2. Hourly mean"
for HR in `seq -w 00 23`; do
    CDO selhour,${HR} ${VAR}_${EXP}_${DATASET}_hr_${YR}.nc ${VAR}_${EXP}_${DATASET}_${HR}hr_${YR}.nc
    CDO timmean ${VAR}_${EXP}_${DATASET}_${HR}hr_${YR}.nc ${VAR}_${EXP}_${DATASET}_${YR}hr_${YR}_timmean.nc
done
...
${BIN}/./regrid ${VAR}_${EXP}_${DATASET}_hr_${YR}.nc 20.23606,70.85755,0.11 -42.69011,61.59245,0.11 bil
...
CDO sellonlatbox,1,16,40,50 ${VAR}_${EXP}_${DATASET}_hr_${YR}_lonlat.nc ${VAR}_${EXP}_FPS_${DATASET}_hr_${YR}_lonlat.nc
...
rm ${VAR}_${EXP}_${DATASET}_hr_${YR}_lonlat.nc
