...
for VAR in ${VAR_LIST[@]}; do
    ...
    elif [ ${INST} == 'RegCM5-ERA5_USP-garoa' ]; then
    DIR_IN="/leonardo/home/userexternal/mdasilva/reg-era5_garoa"
    elif [ ${INST} == 'RegCM5-ERA5_USP-dt60' ]; then
    DIR_IN="/leonardo/home/userexternal/mdasilva/reg-era5_dt60"
    else
    ...
    CDO selvar,${VAR} ${DIR_IN}/${EXP}_SRF.1970010100.nc ${VAR}_${EXP}_1970010100.nc
    CDO selvar,${VAR} ${DIR_IN}/${EXP}_SRF.1970020100.nc ${VAR}_${EXP}_1970020100.nc
    CDO mergetime ${VAR}_${EXP}_1970010100.nc ${VAR}_${EXP}_1970020100.nc ${VAR}_${EXP}_${YEAR}${MON}.nc
    if [ ${VAR} == 'pr' ]; then
    CDO -b f32 mulc,10800 ${VAR}_${EXP}_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}.nc
    CDO daysum ${VAR}_${EXP}_${INST}_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc
    CDO monmean ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_mon_${YEAR}${MON}.nc
    CDO timmin ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}_min.nc
    CDO timmax ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}_max.nc
    ...
    CDO selvar,${VAR} ${DIR_IN}/${EXP}_STS.1970010100-dt60.nc ${VAR}_${EXP}_1970010100.nc
    CDO selvar,${VAR} ${DIR_IN}/${EXP}_STS.1970020100-dt60.nc ${VAR}_${EXP}_1970020100.nc
    CDO mergetime ${VAR}_${EXP}_1970010100.nc ${VAR}_${EXP}_1970020100.nc ${VAR}_${EXP}_${YEAR}${MON}.nc
    if [ ${VAR} == 'pr' ]; then
    CDO -b f32 mulc,86400 ${VAR}_${EXP}_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}.nc
    CDO daysum ${VAR}_${EXP}_${INST}_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc
    CDO monmean ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_mon_${YEAR}${MON}.nc
    CDO timmin ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}_min.nc
    CDO timmax ${VAR}_${EXP}_${INST}_day_${YEAR}${MON}.nc ${VAR}_${EXP}_${INST}_${YEAR}${MON}_max.nc
