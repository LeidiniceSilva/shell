...
VAR_LIST="pr tas tasmax tasmin sfcWind huss"

DIR_OUT="/leonardo/home/userexternal/mdasilva/leonardo_work/CORDEX5/postproc/urb/paper"
...
for VAR in ${VAR_LIST[@]}; do
    ...
    echo
    echo "Merge files"
    CDO mergetime ${DIR_IN}/${VAR}_${DOMAIN}_${EXP}_${FREQ}_200*.nc ${VAR}_${DOMAIN}_${EXP}_${FREQ}_${YR}.nc
