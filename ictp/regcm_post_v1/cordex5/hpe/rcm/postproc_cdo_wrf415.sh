...
for DOMAIN in ${DOMAINS[@]}; do
	...
	DIR_IN="/leonardo/home/userexternal/mdasilva/leonardo_work/WRF415/PREC_ACC_NC"
	DIR_OUT="/leonardo/home/userexternal/mdasilva/leonardo_work/CORDEX5/postproc/hpe/rcm/CSAM-3/WRF415"
	...
	for YEAR in `seq -w 2000 2009`; do
		for MON in `seq -w 01 12`; do
			...
			${BIN}/./regrid ${VAR}_${DOMAIN}_${EXP}_${YEAR}${MON}.nc -35.25,-22.25,0.0275 -60.25,-50.25,0.0275 bil
		done
	echo
	echo "Merge files"
