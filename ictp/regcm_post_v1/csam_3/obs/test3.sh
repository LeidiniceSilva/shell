...
CDO timmin ${VAR}_${EXP}_ERA5_1hr_${YR}.nc ${VAR}_${EXP}_ERA5_1hr_${YR}_min.nc
CDO timmax ${VAR}_${EXP}_ERA5_1hr_${YR}.nc ${VAR}_${EXP}_ERA5_1hr_${YR}_max.nc
CDO timpctl,99 ${VAR}_${EXP}_ERA5_1hr_${YR}.nc ${VAR}_${EXP}_ERA5_1hr_${YR}_min.nc ${VAR}_${EXP}_ERA5_1hr_${YR}_max.nc p99_${EXP}_ERA5_1hr_${YR}.nc

echo
echo "2. Calculate Freq"
CDO mulc,100 -histfreq,${TH},100000 ${VAR}_${EXP}_ERA5_1hr_${YR}.nc ${VAR}_freq_${EXP}_ERA5_1hr_${YR}_th${TH}.nc
