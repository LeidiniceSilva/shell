...
hdir=/leonardo/home/userexternal/mdasilva/github_projects/shell/ictp/regcm_post_v2/scripts_regcm
...
# echo $this_run
  ...
  if [[ $this_run -eq 1 ]]; then
    ...
    [[ $this_postproc = ${mn}_vert_v2 ]] && post_sigma=true
  ...
  if [[ $this_run -eq 1 ]]; then
    ...
    #echo "bash $hdir/${this_postproc}.sh $dom $conf $rdir $odir $yrs $hdir $em"
    ...
    #echo "sbatch $em -J $j -o $o -e $e $dep $scr $dom $conf $rdir $odir $yrs $hdir"
  fi
done
