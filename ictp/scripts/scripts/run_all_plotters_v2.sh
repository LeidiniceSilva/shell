...
plots=("4s_simple_v2" "prpct" "p99" "prc2pr" "4s_frq-int" "pdfs_v2" "vert" "quv" "taylor_diagram_v2" "pixels")
nrun=$(( ${#plots[@]} - 1 ))

#sdir=/marconi/home/userexternal/jciarlo0/regcm_tests/Atlas2
sdir=/marconi/home/userexternal/mdasilva/scripts_2024/scripts_regcm
