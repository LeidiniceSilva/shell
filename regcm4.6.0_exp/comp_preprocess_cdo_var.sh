...
for VAR in pre t2m; do
    ...
    cdo sellonlatbox,-52.5,-45.5,-3.55,3.5 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A2.nc
    cdo sellonlatbox,-75,-71,-15,-11 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A3.nc
    cdo sellonlatbox,-78,-72,0,8 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A4.nc
    cdo sellonlatbox,-73,-65,-10,-3 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A5.nc
    cdo sellonlatbox,-48,-38,-5,-1 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A6.nc
    cdo sellonlatbox,-48,-38,-11,-5 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A7.nc
    cdo sellonlatbox,-38,-34,-11,-5 ${VAR}_amz_neb_regcm_${SIM}_2001-2005.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_A8.nc
    ...
    cdo -b 32 -ymonsub ${VAR}_*_monmean.nc -ymonmean ${VAR}_*_monmean.nc ${VAR}_amz_neb_regcm_${SIM}_2001-2005_monanom.nc
    ...
    ./GrADSNcPrepare ${VAR}_amz_neb_regcm_${SIM}_2001-2005_monanom.nc
