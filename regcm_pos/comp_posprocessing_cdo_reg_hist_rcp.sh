...
EXP="historical"
DATA="1986-2005"
DIR="/home/nice/Documents/exp_reg"
...
for YEAR in `seq -w 1986 2005`; do
    for MON in `seq -w 01 12`; do
        ...
        cdo selname,pr reg_amz_neb_${EXP}_STS.${YEAR}${MON}0100.nc pr_flux_reg_had_${EXP}_${YEAR}${MON}0100.nc
        echo "Data: ${YEAR}${MON} - Variable: Temperature 2 m"
        cdo selname,tas reg_amz_neb_${EXP}_STS.${YEAR}${MON}0100.nc tas_kelv_reg_had_${EXP}_${YEAR}${MON}0100.nc
...
echo "Data: ${DATA} - Variables: Precipitation"
cdo setcalendar,standard pr_flux_reg_had_${EXP}_${DATA}.nc pr_amz_neb_reg_had_${EXP}_${DATA}_stand.nc
echo "Data: ${DATA} - Variable: Temperature 2 m"
cdo setcalendar,standard tas_kelv_reg_had_${EXP}_${DATA}.nc tas_amz_neb_reg_had_${EXP}_${DATA}_stand.nc

echo 
echo "4. Unit convention (mm/d and celsius)"

echo "Data: ${DATA} - Variables: Precipitation"
cdo mulc,86400 pr_amz_neb_reg_had_${EXP}_${DATA}_stand.nc pr_amz_neb_reg_had_${EXP}_${DATA}.nc
echo "Data: ${DATA} - Variable: Temperature 2 m"
cdo addc,-273.15 tas_amz_neb_reg_had_${EXP}_${DATA}_stand.nc tas_amz_neb_reg_had_${EXP}_${DATA}.nc
