...
model_list=( 'BCC-CSM1.1' 'BCC-CSM1.1M' 'BNU-ESM' 'CanESM2' 'CCSM4' 'CESM1-BGC' 'CESM1-CAM5' 'CCESM1-FASTCHEM' 'CESM1-WACCM' 'CMCC-CMS' 'CNRM-CM5' 'CSIRO-ACCESS-1' 'CSIRO-ACCESS-3' 'FGOALS-g2' 'FGOALS-s2' 'FIO-ESM' 'GFDL-ESM2G' 'GFDL-ESM2M' 'GISS-E2-H-CC' 'GISS-E2-H' 'GISS-E2-R-CC' 'GISS-E2-R' 'HadGEM2-ES' 'INMCM4' 'IPSL-CM5A-LR' 'IPSL-CM5A-MR' 'MIROC5' 'MIROC-ESM' 'MPI-ESM-LR' 'MPI-ESM-MR' 'MRI-CGCM3' 'NorESM1-ME' 'NorESM1-M' )    
...
for model in ${model_list[@]}; do
	...
	echo
	echo "3. Convert unit"
	cdo addc,-273.15 ${var}_Amon_${model}_${exp}_gr_1961-2014_calendar.nc ${var}_SA_Amon_${model}_${exp}_gr_1961-2014.nc
